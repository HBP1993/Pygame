...
class Alien(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        self.settings = ai_game.settings #using setting
    ...
    #We need a method to check whether an alien is at either edge
    # modify update() to allow each alien to move in the appropriate direction.         
    ...
    def update(self):
        ...
        #right by the amount stored in alien_speed.
        self.rect.x = self.x
